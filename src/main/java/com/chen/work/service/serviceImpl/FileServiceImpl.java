...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        // 获取基本信息
        String endpoint = "ap-nanjing";
        String bucketName = "lxc-1312149144";
        String secretId = "AKIDAAtLXS7VcT3LMBk23nHTO2QXruhDSQ7X";
        String secretKey = "A3ey2pLbeRxDCtJSKvFI4ZmiOoxqSotg";
        ...
        try{
            ...
            // 指定key
            String key = "BookSystem/" + UUID.randomUUID().toString().replaceAll("-","")+
